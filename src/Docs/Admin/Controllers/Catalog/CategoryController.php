...
class CategoryController
{
     ...
     *                      type="object",
     *                      @OA\Property(property="is_root", type="boolean", description="Is current category root?", example="true"),
     ...
     *                      @OA\Property(property="code", type="string", description="Category unique code", example="SomeCode"),
     *                      @OA\Property(property="parent_code", type="string", description="Category parent unique code", example="SomeParentCode"),
     *                      @OA\Property(property="additional", type="string", description="Additional data"),
